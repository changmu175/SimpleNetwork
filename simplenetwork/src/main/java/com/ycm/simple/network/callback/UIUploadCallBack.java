...
public abstract class UIUploadCallBack implements UploadCallBack {
    ...
    private static class UIHandler extends Handler {
        private final WeakReference<UIUploadCallBack> callBackWeakReference;

        public UIHandler(Looper looper, UIUploadCallBack uiProgressResponseListener) {
            super(looper);
            callBackWeakReference = new WeakReference<UIUploadCallBack>(uiProgressResponseListener);
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case RESPONSE_UPDATE:
                    UIUploadCallBack uiProgressResponseListener = callBackWeakReference.get();
